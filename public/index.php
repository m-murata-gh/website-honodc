  ...
  <div class="inner--wide mv__inner--wide">
    ...
    <div class="leaf-msg mv__leaf-msg">
      <div class="leaf-msg__inner">
        <div class="leaf-msg__item--sm"><img src="assets/images/leaf-msg-sm.svg" alt=""></div><!-- /.leaf-msg__item--lg -->
        <div class="leaf-msg__item--lg"><img src="assets/images/leaf-msg-lg.svg" alt=""></div><!-- /.leaf-msg__item--lg -->
      </div><!-- /.leaf-msg__inner -->
    </div>
    <!-- /.mv__leaf-msg -->
    ...
    <div class="inner news__inner">
      ...
      <div class="news__contents">
        <dl class="vertical-posts">
          <div><a class="vertical-posts__item cf" href="{$GLOBALS['urlNewsArticle1']}">
            <dt class="vertical-posts__date"><time>2021.05.21(Fri)</time></dt>
            <dt class="label vertical-posts__label">お知らせ</dt>
            <dd class="vertical-posts__title">2021年6月の診療日</dd>
          ...
          <div><a class="vertical-posts__item cf" href="{$GLOBALS['urlNewsArticle2']}">
            <dt class="vertical-posts__date"><time>2021.04.23(Fri)</time></dt>
            <dt class="label vertical-posts__label">お知らせ</dt>
            <dt class="label--important vertical-posts__label">重要</dt>
            <dd class="vertical-posts__title">2021年5月 GW休診日</dd>
            <dd class="vertical-posts__paragraph">
          ...
          <div><a class="vertical-posts__item cf" href="{$GLOBALS['urlNewsArticle3']}">
            <dt class="vertical-posts__date"><time>2021.04.01(Thu)</time></dt>
            <dt class="label vertical-posts__label">お知らせ</dt>
            <dt class="label--important vertical-posts__label">重要</dt>
            <dd class="vertical-posts__title">新型コロナ感染対策について</dd>
            <dd class="vertical-posts__paragraph">
